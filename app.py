...
co_cities = co_cities.query("admin_name in ['Meta', 'Guaviare']")


fig = px.line_mapbox(co_cities, lat="lat", lon="lng", color="admin_name", zoom=3, height=300, title="Intento de líneas con MAPBOX Colombia")
